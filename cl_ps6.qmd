...
```{python}
print(f"There are {len(top_alerts_aggregated)} rowd in this DataFrame.")
```
...
chart = alt.Chart(top_10).mark_circle().encode(
    x = alt.X("binned_long:Q", scale = alt.Scale(domain = [-90, 90])),
    y = alt.Y("binned_lat:Q", scale = alt.Scale(domain = [-90, 90])),
