...
type = Accident
  ...
  subtype 3 = Unclassified
    subsub 3 = Unclassified
type = Hazard
  subtype 1 = Hazard On Road
    subsub 1 = None
    subsub 2 = Car Stopped
    subsub 3 = Construction
    subsub 4 = Emergency Vehicle
  ...
  subtype 3 = Hazard Weather
    ...
    subsub 4 = Heavy Snow
type = Traffic
  subtype 1 = Heavy Traffic
    subsub 1 = None
  subtype 2 = Moderate Traffic
    subsub 2 = None
  subtype 3 = Standstill Traffic
    subsub 3 = None
  subtype 4 = Unclassified
    subsub 4 = Unclassified
type = Road Closed
  subtype 1 = Road Closed Event
    subsub 1 = None
  subtype 2 = Unclassified
    subsub 2 = Unclassified

4. 
```{python}
# create crosswalk dataframe manually 
crosswalk_manual ={
"type": ["ACCIDENT", "ACCIDENT", "ACCIDENT", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "JAM", "JAM", "JAM", "JAM", "ROAD_CLOSED", "ROAD_CLOSED"],

"subtype" : ["ACCIDENT_MAJOR", "ACCIDENT_MINOR", "ACCIDENT_UNCLASSIFIED", "HAZARD_ON_ROAD", "HAZARD_ON_ROAD_CAR_STOPPED", "HAZARD_ON_ROAD_CONSTRUCTION", "HAZARD_ON_ROAD_EMERGENCY_VEHICLE", "HAZARD_ON_ROAD_LANE_CLOSED", "HAZARD_ON_ROAD_OBJECT", "HAZARD_ON_ROAD_POT_HOLE", "HAZARD_ON_ROAD_ROAD_KILL", "HAZARD_ON_ROAD_TRAFFIC_LIGHT_FAULT", "HAZARD_ON_SHOULDER_CAR_STOPPED", "HAZARD_WEATHER", "HAZARD_WEATHER_FLOOD", "HAZARD_WEATHER_FOG", "HAZARD_WEATHER_HEAVY_SNOW", "JAM_HEAVY_TRAFFIC", "JAM_MODERATE_TRAFFIC", "JAM_STAND_STILL_TRAFFIC", "JAM_UNCLASSIFIED", "ROAD_CLOSED_EVENT", "ROAD_CLOSED_UNCLASSIFIED"], 

"updated_type" : ["ACCIDENT", "ACCIDENT", "ACCIDENT", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "HAZARD", "TRAFFIC", "TRAFFIC", "TRAFFIC", "TRAFFIC", "ROAD_CLOSED", "ROAD_CLOSED"],

"updated_subtype" : ["MAJOR", "MINOR", "UNCLASSIFIED", "ON ROAD",  "ON ROAD", "ON ROAD", "ON ROAD","ON ROAD", "ON ROAD", "ON ROAD", "ON ROAD", "ON ROAD", "ON SHOULDER", "WEATHER", "WEATHER", "WEATHER", "WEATHER", "HEAVY", "MODERATE", "STANDSTILL", "UNCLASSIFIED", "EVENT", "UNCLASSIFIED"], 

"updated_subsubtype" : ["UNCLASSIFIED", "UNCLASSIFIED", "UNCLASSIFIED", "NONE", "CAR STOPPED", "CONSTRUCTION", "EMERGENCY VEHICLE","LANE CLOSED", "OBJECT", "POT HOLE", "ROAD KILL", "TRAFFIC LIGHT BROKEN", "CAR STOPPED", "NONE", "FLOOD", "FOG", "HEAVY SNOW", "NONE", "NONE", "NONE", "UNCLASSIFIED", "NONE", "UNCLASSIFIED"]
} 
...
binned_count = (merged_df.groupby(["binned_lat", "binned_long"]).size().reset_index(name = "count"))
max_binned_combo = binned_count.loc[binned_count["count"].idmax()]
print(f"The latitude-longitude combination with the greated number of observations is: {max_binned_combo}")
```
