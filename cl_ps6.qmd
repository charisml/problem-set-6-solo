...
c. 
```{python}
alerts_df = merged_df.merge(bin_count, on = "binned_lat", how = "left")
top_alerts_map = alerts_df[["type", "subtype", "binned_lat", "binned_lat", "count"]]
top_10 = type_sub_bin.nlargest(10, "type_sub_count")
```
