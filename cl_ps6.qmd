...
print(top_alerts_aggregated.head(10))
# filter for type and subtype
# filter_df = top_alerts_aggrgated[(top_alerts_aggregated["type"] == type) & (top_alerts_aggregated["subtype"] == )]
# top_10 = filter_df.sort_values("count", ascending = False).head(10)
# top_10.tocsv("top_alerts_map.csv", index = False)
```
